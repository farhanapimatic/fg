...
```java
String authUrl = client.auth().buildAuthorizationUrl(); // build auth url
...
```java
// load token later...
com.amazon.webservices.Configuration.oAuthToken = (OAuthToken) httpSession.getAttribute("access_token");
...
import com.amazon.webservices.models.OAuthToken;
...
public class MainController {
    ...
    public MainController() {
        ...
        this.client = new AWSECommerceServiceClient(oAuthClientId, oAuthClientSecret, oAuthRedirectUri);
    }
    ...
    public String callApi(HttpSession session, HttpServletResponse response) throws Throwable {
        ...
        synchronized (client) {
            com.amazon.webservices.Configuration.oAuthToken = (OAuthToken) session.getAttribute("access_token");
...
// Invoking the API call with sample inputs
oAuthAuthorization.createRequestTokenAsync(authorization, code, redirectUri, formParams, new APICallBack<OAuthToken>() {
...
### <a name="create_request_token1_async"></a>![Method: ](https://apidocs.io/img/method.png "com.amazon.webservices.controllers.OAuthAuthorizationController.createRequestToken1Async") createRequestToken1Async
...
Map<String, Object> formParams = new LinkedHashMap<String, Object>();
// Invoking the API call with sample inputs
oAuthAuthorization.createRequestToken1Async(authorization, code, redirectUri, formParams, new APICallBack<OAuthToken>() {
    public void onSuccess(HttpContext context, OAuthToken response) {
        // TODO success callback handler
    }
    public void onFailure(HttpContext context, Throwable error) {
...
### <a name="create_refresh_token1_async"></a>![Method: ](https://apidocs.io/img/method.png "com.amazon.webservices.controllers.OAuthAuthorizationController.createRefreshToken1Async") createRefreshToken1Async
...
### <a name="create_request_token2_async"></a>![Method: ](https://apidocs.io/img/method.png "com.amazon.webservices.controllers.OAuthAuthorizationController.createRequestToken2Async") createRequestToken2Async
...
Map<String, Object> formParams = new LinkedHashMap<String, Object>();
// Invoking the API call with sample inputs
oAuthAuthorization.createRequestToken2Async(authorization, code, redirectUri, formParams, new APICallBack<OAuthToken>() {
    public void onSuccess(HttpContext context, OAuthToken response) {
        // TODO success callback handler
    }
    public void onFailure(HttpContext context, Throwable error) {
...
### <a name="create_refresh_token2_async"></a>![Method: ](https://apidocs.io/img/method.png "com.amazon.webservices.controllers.OAuthAuthorizationController.createRefreshToken2Async") createRefreshToken2Async
...
### <a name="create_request_token11_async"></a>![Method: ](https://apidocs.io/img/method.png "com.amazon.webservices.controllers.OAuthAuthorizationController.createRequestToken11Async") createRequestToken11Async
...
Map<String, Object> formParams = new LinkedHashMap<String, Object>();
// Invoking the API call with sample inputs
oAuthAuthorization.createRequestToken11Async(authorization, code, redirectUri, formParams, new APICallBack<OAuthToken>() {
    public void onSuccess(HttpContext context, OAuthToken response) {
        // TODO success callback handler
    }
    public void onFailure(HttpContext context, Throwable error) {
...
### <a name="create_refresh_token11_async"></a>![Method: ](https://apidocs.io/img/method.png "com.amazon.webservices.controllers.OAuthAuthorizationController.createRefreshToken11Async") createRefreshToken11Async
...
### <a name="create_request_token21_async"></a>![Method: ](https://apidocs.io/img/method.png "com.amazon.webservices.controllers.OAuthAuthorizationController.createRequestToken21Async") createRequestToken21Async
...
Map<String, Object> formParams = new LinkedHashMap<String, Object>();
// Invoking the API call with sample inputs
oAuthAuthorization.createRequestToken21Async(authorization, code, redirectUri, formParams, new APICallBack<OAuthToken>() {
    public void onSuccess(HttpContext context, OAuthToken response) {
        // TODO success callback handler
    }
    public void onFailure(HttpContext context, Throwable error) {
...
### <a name="create_refresh_token21_async"></a>![Method: ](https://apidocs.io/img/method.png "com.amazon.webservices.controllers.OAuthAuthorizationController.createRefreshToken21Async") createRefreshToken21Async
...
### <a name="create_request_token3_async"></a>![Method: ](https://apidocs.io/img/method.png "com.amazon.webservices.controllers.OAuthAuthorizationController.createRequestToken3Async") createRequestToken3Async
...
Map<String, Object> formParams = new LinkedHashMap<String, Object>();
// Invoking the API call with sample inputs
oAuthAuthorization.createRequestToken3Async(authorization, code, redirectUri, formParams, new APICallBack<OAuthToken>() {
    public void onSuccess(HttpContext context, OAuthToken response) {
        // TODO success callback handler
    }
    public void onFailure(HttpContext context, Throwable error) {
...
### <a name="create_refresh_token3_async"></a>![Method: ](https://apidocs.io/img/method.png "com.amazon.webservices.controllers.OAuthAuthorizationController.createRefreshToken3Async") createRefreshToken3Async
