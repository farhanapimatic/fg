...
```javascript
function createRequestToken2(authorization, code, redirectUri, formParams, callback)
```
#### Parameters
...
```javascript
    ...
    controller.createRequestToken2(authorization, code, redirectUri, formParams, function(error, response, context) {
